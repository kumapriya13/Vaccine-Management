...
import { RecipientService, VaccinatorService } from '../../core';
...
export class AdverseEventReportingComponent implements OnInit {
  ...
  ngOnInit(): void {
    if(this._recipientService?.vaccinationDate){
      this.minDate = new Date(this._recipientService?.vaccinationDate);
      console.log('Calender minDate ...'+this.minDate )
