...
export class AdminRecipientInviteFormComponent implements OnInit {
  @Input() email: any;
  ...
  constructor(
   ...
   checkValid() {
    this.valid =  (this.resendInvite || !!(this.userType && this.selectedEmail && this.selectedMobileNumber)) ? false : true ;
  }
