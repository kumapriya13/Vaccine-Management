...
@Component({
  selector: 'app-page-admin-set-new-password',
  templateUrl: './page-admin-set-new-password.component.html',
  styleUrls: ['./page-admin-set-new-password.component.scss'],
})
export class PageAdminSetNewPasswordComponent implements OnInit {
...
enable :boolean = true;
  ...
  changePasswordHandler() {
    ...
    this.providerAdminAuthService
      .adminConfirmNewAdmin(newChangedPasswordData)
      .subscribe(
        (res) => {
