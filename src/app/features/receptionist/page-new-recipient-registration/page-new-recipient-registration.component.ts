...
import { applicableList, passwordContext, raceList, medicalList, GENDER_TYPES, GENDER_TYPES_FOR_ADD } from 'src/app/shared/helpers/constant';
...
@Component({
  selector: 'app-page-new-recipient-registration',
  templateUrl: './page-new-recipient-registration.component.html',
  styleUrls: ['./page-new-recipient-registration.component.scss']
})
export class PageNewRecipientRegistrationComponent {
  isNew: boolean = true;
    recepientId: any;
